...
////import com.kmsb.flights.restful.model.FlightStatesDeserializer;
//import okhttp3.*;
//
...
//     */
//    public OpenSkyRestClient(String username, String password) {
//        lastRequestTime = new HashMap<>();
//        // set up JSON mapper
//        mapper = new ObjectMapper();
//        SimpleModule sm = new SimpleModule();
//        sm.addDeserializer(FlightStates.class, new FlightStatesDeserializer());
...
//     */
//    private FlightStates getResponse(String baseUri, Collection<AbstractMap.Entry<String, String>> nvps) throws IOException {
...
//        }
//        if (charset != null) {
//            return mapper.readValue(new InputStreamReader(response.body().byteStream(), charset), FlightStates.class);
//        } else {
...
//     * @throws IOException if there was an HTTP error
//     */
//    private FlightStates getFlightStates(String baseUri, ArrayList<AbstractMap.Entry<String, String>> nvps) throws IOException {
//        try {
...
//     * @return {@link FlightStates} if request was successful, {@code null} otherwise or if there's no new data/rate limit reached
//     * @throws IOException if there was an HTTP error
//     */
//    public FlightStates getStates(int time, String[] icao24) throws IOException {
...
//        return checkRateLimit(REQUEST_TYPE.GET_STATES, 4900, 9900) ? getFlightStates(STATES_URI, nvps) : null;
//    }
//
//    /**
...
//     * @throws IOException if there was an HTTP error
//     */
//    public FlightStates getMyStates(int time, String[] icao24, Integer[] serials) throws IOException {
//        if (!authenticated) {
...
//        }
//        nvps.add(new AbstractMap.SimpleImmutableEntry<>("time", Integer.toString(time)));
//        return checkRateLimit(REQUEST_TYPE.GET_MY_STATES, 900, 0) ? getFlightStates(MY_STATES_URI, nvps) : null;
//    }
//
//}
